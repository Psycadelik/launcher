...
{
    /**
     * fetch records from company details db
     */
    public function  highCharts()
    {
        $y2006Details = CompanyDetail::where ( 'year', '2006' )->get ();
        $y2007Details = CompanyDetail::where ( 'year', '2007' )->get ();
        $y2008Details = CompanyDetail::where ( 'year', '2008' )->get ();
        $y2009Details = CompanyDetail::where ( 'year', '2009' )->get ();
        $y2010Details = CompanyDetail::where ( 'year', '2010' )->get ();
        $y2011Details = CompanyDetail::where ( 'year', '2011' )->get ();
        $y2012Details = CompanyDetail::where ( 'year', '2012' )->get ();
        $y2013Details = CompanyDetail::where ( 'year', '2013' )->get ();
        $y2014Details = CompanyDetail::where ( 'year', '2014' )->get ();
        $y2015Details = CompanyDetail::where ( 'year', '2015' )->get ();

        $companyNames = CompanyDetail::select ( 'company' )->groupBy ( 'company' )->get ();
